        ...
        <div className="detail-card">
          <div className="subscription-container">
            ...
            {this.props.eventData.is_subscribed && !this.state.isUpdate ? (
                 <div className={eventData.event_status==="upcoming"?"upcoming-subscribed":"already-subscribed-block"}>
              ...
              <div className="subscription-left">
                ...
                <div className="breakdown">
                  <div>Total Amount : ₹{this.state.totalAmount.toFixed(2)}</div>
                  {this.state.codeApplied && (
                    <div>
                      Discount : - ₹
                      {this.state.codeApplied &&
                        (this.state.totalAmount *
                          (this.props.discountPercentage / 100)).toFixed(2)}
                    </div>
                  )}
                  <div>
                    Amount payble: ₹
                    {this.state.codeApplied
                      ? this.state.totalAmountAfterPromo.toFixed(2)
